...
public class GameTestProgram {
    public static void main(String args[]) throws CollisionException {
        ...
        // Add some players
        //g.add(new Game.Player("Blue Guy", Color.BLUE, new Game.Point2D(38,156), 90));
        //g.add(new Game.Player("Yellow Guy", Color.YELLOW, new Game.Point2D(55,37), 270));
        //g.add(new Game.Player("Green Guy", Color.GREEN, new Game.Point2D(147,116), 0));

        // Add the ball
        //g.add(new Game.Ball(new Game.Point2D(90, 90)));

        System.out.println("Here are the Game.Game Objects:");
        g.displayObjects();

        // Test out some Game.Player and Game.Ball movement
        System.out.println("--------------------------------------------------------");
        ...
        System.out.println("\nHere are the Game.Harmful Objects:");
