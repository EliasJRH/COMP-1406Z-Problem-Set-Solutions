...
public class Ball extends MovableObject implements Harmful{
    ...
    public String toString() {
        return "Game.Ball" + " at (" + (int)location.getX() + "," + (int)location.getY() + ") facing " + direction +
                " degrees going " + speed + " pixels per second";
    }

    public void draw() {
        //System.out.println("Game.Ball is at (" + (int)location.getX() + "," + (int)location.getY() + ") facing " + direction + " degrees and moving at " + speed + " pixels per second");
    }
